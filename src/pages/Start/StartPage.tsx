...
export const StartPage = () => {
	...
	const isErrors = (errors: FormikErrors<GameSettings>) =>
	...
	return (
		<div className={style.Page}>
			...
			<div className={style.Container}>
				...
				>
					{({ errors }) => (
						<Form>
							...
							/>
							<Button disabled={isErrors(errors)} type="submit">
								Start Game
							</Button>
						</Form>
					)}
				...
				<span>
					Players choose <span className={style.Yellow}>yellow</span>{' '}
					or <span className={style.Red}>red</span> discs.
					<hr />
					They drop the discs into the grid, starting in the middle or
					at the edge to stack their colored discs upwards,
